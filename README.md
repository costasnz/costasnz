<h1 align="center">Rúben Costa</h1>

<p align="center">
  <strong>Estudante de Engenharia Informática @ ISEC</strong> — a construir base sólida em<br/>
  sistemas, C / C++ / Java e IA · 🌍 Erasmus na Polónia (set 2026) · 🎯 à procura de estágio em software
</p>
...
Programo desde o 1.º ano em C, C++ e Java, com foco em **sistemas operativos** (Unix e Win32) e **bases de dados**. Gosto de perceber o que está por baixo da abstração — e de construir ferramentas que uso mesmo no dia a dia.

### 🔧 No que ando a trabalhar

- 🧵 **Sistemas Operativos em C** — concorrência com named pipes, memória partilhada e threads (Win32) e processos/`fork`/pipes (Unix).
- ☕ **Java avançado** — design patterns (Command, Facade, MVC) e JavaFX.
- 🧠 **Ferramentas pessoais com LLMs** — um segundo-cérebro em Markdown mantido por agentes.
